...
class ChatType extends $pb.ProtobufEnum {
  static const ChatType USE_CHAT = ChatType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'USE_CHAT');
  static const ChatType GROUP_CHAT = ChatType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GROUP_CHAT');
