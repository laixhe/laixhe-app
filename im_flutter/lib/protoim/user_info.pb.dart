...
class UserInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protoim'), createEmptyInstance: create)
    ...
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isOk')
  ...
  @$pb.TagNumber(4)
  $core.bool get isOk => $_getBF(3);
  @$pb.TagNumber(4)
  set isOk($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasIsOk() => $_has(3);
  @$pb.TagNumber(4)
  void clearIsOk() => clearField(4);
}
